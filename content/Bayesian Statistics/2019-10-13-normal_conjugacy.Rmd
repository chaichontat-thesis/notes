...
&\propto (\tst)^{n/2+\alpha-1} \, \expb{-\tst\left[\frac{(n-1)s_x^2}{2} + \beta\right]} \\
&\propto \mathrm{Gamma}\left(\frac{n}{2}+\alpha, \frac{(n-1)s_x^2}{2} + \beta\right)
\end{align}
$$
If we define $\alpha = \frac{n_0}{2}$ and $\beta=\frac{n_0\sigma_0^2}{2}$, then
$$
p(\tst \mid \xdots, \mu) \sim \mathrm{Gamma}\pp{\frac{n+n_0}{2}, \frac{(n-1)s_x^2+n_0\sigma_0^2}{2}}
$$
### Interpretations
...
&= \mathrm{InverseGamma}\pp{\frac{n_{0,\sigma^2}+n}{2}, \frac{1}{n_{0,\sigma^2}+n}\left[n_{0,\sigma^2}\sigma_0^2+(n-1)s^2+\frac{n_{0,\mu}\, n}{n_{0,\mu}}(\bar{x}-\mu_0)^2\right]} \\
\end{align}
$$
If we assume that $n_{0,\sigma^2} = n_{0,\mu}$.
$$
p(\sigma^2,\xdots) = \mathrm{InverseGamma}\pp{\frac{n_{0}+n}{2}, \frac{1}{n_{0}+n}\left[n_{0}\sigma_0^2+(n-1)s^2+ n(\bar{x}-\mu_0)^2\right]}
$$
...
$$
\begin{align}
\sigma^2 &\sim \mathrm{InverseGamma}\pp{\frac{n_{0,\sigma^2}}{2}, \frac{n_{0,\sigma^2}\sigma_0^2}{2}} \\
...
$$
\begin{align}
\sigma^2 &\sim \mathrm{InverseGamma}\pp{\frac{n_{0,\sigma^2}+n}{2}, \frac{1}{n_{0,\sigma^2}+n}\left[n_{0,\sigma^2}\sigma_0^2+(n-1)s^2+\frac{n_{0,\mu}\, n}{n_{0,\mu}}(\bar{x}-\mu_0)^2\right]} \\
...
&\propto \mathrm{Gamma}\pp{\frac{n+n_0}{2}, \frac{(n-1)s_x^2+n_0\sigma_0^2}{2}} \\~\\
